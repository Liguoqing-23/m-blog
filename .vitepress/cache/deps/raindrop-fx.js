...
// node_modules/raindrop-fx/dist/index.js
var require_dist = __commonJS({
  "node_modules/raindrop-fx/dist/index.js"(exports, module) {
      ...
      (function(e) {
        (function(t) {
          ...
          var r = Object.prototype.hasOwnProperty, i = typeof Symbol == "function", n = i && typeof Symbol.toPrimitive != "undefined" ? Symbol.toPrimitive : "@@toPrimitive", s = i && typeof Symbol.iterator != "undefined" ? Symbol.iterator : "@@iterator", a = typeof Object.create == "function", o = { __proto__: [] } instanceof Array, l = !a && !o, c = { create: a ? function() {
            return Xr(/* @__PURE__ */ Object.create(null));
          } : o ? function() {
    ...
    var Tt = B((Xe) => {
      ...
      var Rs = class {
        constructor() {
          this.assetsMap = /* @__PURE__ */ new Map(), this.id = 1, this.eventEmitter = new gd.EventEmitter();
        }
        newAssetID(t) {
          let r = ++this.id;
...
`;
    ...
    var na = B((qr) => {
      ...
      var i0 = We(), Ks = Pe(), n0 = xt(), Oe = si(), vt = bi(), ea = Kt(), De = Ce(), s0 = Js(), Gr = xr(), ta = Cr(), ra = Ut(), a0 = Ft(), ia = class {
        constructor(t, r, i) {
          this.viewProjectionMatrix = Oe.mat4.identity(), this.viewMatrix = Oe.mat4.identity(), this.projectionMatrix = Oe.mat4.identity(), this.target = vt.RenderTarget.CanvasTarget, this.shader = null, this.globalUniforms = /* @__PURE__ */ new Map(), this.globalTextures = /* @__PURE__ */ new Map(), this.canvas = t, this.width = r === void 0 ? t.width : r, this.height = i === void 0 ? t.height : i, this.canvas.width = this.width, this.canvas.height = this.height, this.scissor = new Gr.Rect(De.vec2.zero(), De.vec2(this.width, this.height)), this.gl = i0.panicNull(this.canvas.getContext("webgl2"), "WebGL2 is not support on current device."), this.assets = new s0.BuiltinAssets(this.gl), this.ctx = { gl: this.gl, width: this.width, height: this.height, assets: this.assets, renderer: this }, Ks.GlobalContext() || this.use(), this.helperAssets = { clipBlitMesh: ta.MeshBuilder.ndcQuad(), blitMesh: ta.MeshBuilder.ndcTriangle() };
        }
        use() {
    ...
    var da = B((Nr) => {
      ...
      var fa = class {
        constructor() {
          this.mainAsset = null, this.assets = /* @__PURE__ */ new Map();
        }
        add(t, r) {
...
out vec2 vUV;\r
\r
// Gold Noise ©2015 dcerisano@standard3d.com\r
    ...
    var qi = class {
      ...
      update(t) {
        ...
        for (let r = 0; r < this.raindrops.length; r++)
          this.raindrops[r].destroied && ((_a2 = this.raindrops[r].grid) == null ? void 0 : _a2.delete(this.raindrops[r]), this.raindrops[r] = this.raindrops[this.raindrops.length - 1], this.raindrops.length--);
      }
      raindropUpdate(t) {
        var _a2;
        for (let r = 0; r < this.raindrops.length; r++) {
          ...
          a !== i.grid && ((_a2 = i.grid) == null ? void 0 : _a2.delete(i), a == null ? void 0 : a.add(i), i.grid = a);
        }
      }
      collisionUpdate() {
...
raindrop-fx/dist/index.js:
  ...
  ***************************************************************************** *)
*/
//# sourceMappingURL=raindrop-fx.js.map
